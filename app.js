  ...
  overlay.innerHTML =
    '<div class="fd-modal fd-modal-guide">' +
      ...
      '<div class="fd-actions">' +
        '<button class="fd-go-btn" style="background:' + sec.color + '" onclick="document.getElementById(\'featureDetailOverlay\').remove();' + item.action + '">' +
...
async function runAnalysis() {
  ...
  <div class="export-bar">
    <span class="export-bar-label">📄 ${_t('보고서 다운로드','Download Report')}</span>
    <div class="export-bar-buttons">
      <button class="export-btn export-btn-txt" onclick="exportReport('txt')">TXT</button>
      <button class="export-btn export-btn-pdf" onclick="exportReport('pdf')">PDF</button>
    </div>
  </div>`;
